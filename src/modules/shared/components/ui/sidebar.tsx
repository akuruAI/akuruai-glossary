...
function SidebarGroupLabel({ ref, className, asChild = false, ...props }: React.ComponentProps<"div"> & { asChild?: boolean } & { ref?: React.RefObject<HTMLDivElement | null> }) {
...
function SidebarGroupAction({ ref, className, asChild = false, ...props }: React.ComponentProps<"button"> & { asChild?: boolean } & { ref?: React.RefObject<HTMLButtonElement | null> }) {
...
function SidebarMenuButton({ ref, asChild = false, isActive = false, variant = "default", size = "default", tooltip, className, ...props }: React.ComponentProps<"button"> & {
  asChild?: boolean;
  isActive?: boolean;
...
function SidebarMenuAction({ ref, className, asChild = false, showOnHover = false, ...props }: React.ComponentProps<"button"> & {
  asChild?: boolean;
  showOnHover?: boolean;
...
function SidebarMenuSubButton({ ref, asChild = false, size = "md", isActive, className, ...props }: React.ComponentProps<"a"> & {
  asChild?: boolean;
  size?: "sm" | "md";
  isActive?: boolean;
